...
public class Hallway08 extends Area<NoState> {

    public Hallway08(final World containingWorld) {
        super(containingWorld);

        this.portals().north(new Portal(false, Hallway06.class))
                .south(new Portal(false, DuanesRoom.class)).west(new Portal(false, Hallway09.class))
