...
public class TutorialArea extends Area{
   ...
   public TutorialArea(World containingWorld){
        ...
        getPortals().east(new Portal(Portal.State.UNLOCKED, "Test02")) //Portals leading east to Test2 and south to Test4
            .south(new Portal(Portal.State.LOCKED, "Test04"));         //The way to Test4 is blocked
