...
public class TutorialArea extends Area{
   ...
   public TutorialArea(World containingWorld){
        ...
        getPortals().setPortal(Direction.EAST, new Portal(Portal.UNLOCKED, "Test2"));           //Portals leading east to Test2 and south to Test4
        getPortals().setPortal(Direction.SOUTH, new Portal(Portal.LOCKED, "Test4"));            //The way to Test4 is blocked
        ...
        addItem(new Door(true,"Southern Door", new Key(),getPortals().getPortal(Direction.SOUTH))); //The way to the south is blocked by a door, named "Southern Door", which uses the Key() item as a key and is connected to the southern portal
