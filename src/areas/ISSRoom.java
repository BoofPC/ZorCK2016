...
public class ISSRoom extends Area {
    ...
    public ISSRoom(final World containingWorld) {
        ...
        this.title("ISS Room")
        .description("You are in the ISS Room, you notice papers randomly scattered across the floor. "
        ...
        .shortDescription("This is the ISS Room, it smells of delinquency, and is absolutely silent.")
        .articleThe(true)
        .dark(false)
