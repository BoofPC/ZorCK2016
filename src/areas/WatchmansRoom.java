...
public class WatchmansRoom extends Area<NoState> {
    public WatchmansRoom(final World containingWorld) {
        ...
        this.title("Watchman's Room")
                .description("This is Mrs. Watchman's room."
                        + " Mrs. Watchman is in the room tring to find the key to the CompSci room."
                        + " There is a door the the north that leads to the CompSci room,"
