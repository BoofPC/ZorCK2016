...
public class Fitz extends Area{
        ...
        public Fitz(World containingWorld){
            ...
            this.portals()
                .north(new Portal(true, SecretPassage.class));
            this.title("Mr. Fitz's Room")
                .description("This is Mr. Fitz's Room, otherwise know as"
                    + " 'The Dungeon of torture.' There is a door to"
                    + " Mr. Petoff's room to the west. There is a secret passage to"
                    + " the north. In this room you can find Mr. Fitz sipping coffee, his lunch,"
                    + " and a desk.")
                .shortDescription("This is Mr. Fitz's Room.")
                .state("First",true)
                .state("take_or_drink_coffee", false)
                .state("take_or_eat_lunch", false)
        ...
        public void interact(Command command, Context context){
            if(command.getVerb().getTitle().equals("Drink") && 
                    ...
                    !this.state("take_or_drink_coffee")){
                ...
                this.state("take_or_drink_coffee", true);
            }
