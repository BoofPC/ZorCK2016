...
public class AdamsonsRoom extends Area<NoState> {
    ...
    public AdamsonsRoom(final World containingWorld) {
        ...
        this.title("Adamson's Room")
                .description(
                        "Banners hang from the ceiling proclaiming the acomplishments "
                                + "of Students. In the middle of the room lay 5 "
                                + "rows of highly advanced computers probably made "
                                + "by aliens. at the front of the room lie two massive "
                                + "movie screen sized monitors.")
