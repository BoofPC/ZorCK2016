...
public class ArthursRoom extends Area{    
       ...
       public ArthursRoom(World containingWorld){      
            ...
            this.title("ArthursRoom")
            .description("This is ms.Arthurs room.Ms. Arthur is grading some papers at her desk using a red pen. Oh look a Frog Heart is on one of the tables."
                       +"To the south. There is Ms.Arthurs desk "
                       +"To the west. There Recycling bins"
                       +"To the East. There are sinks")
            .shortDescription("Students are working on stuff. They are pretty much ignoring you right now.")
