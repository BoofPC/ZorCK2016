 ...
 *
 * when the user says "TAKE ORB," instead of putting the orb in the player's inventory, the player
 * will absorb the orb and gain 10 max hp points
 *
 * To do this, we will write a special take method in the Area in which the orb will be (Test8)
 *
